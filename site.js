...
function createHeading(businessName, questionType) {
  document.write("Use the following information to complete the " + questionType + " of " + businessName + " for the month of " + randomWord(month) + " " + randomWord(year) + "<br>" + "<br>");
